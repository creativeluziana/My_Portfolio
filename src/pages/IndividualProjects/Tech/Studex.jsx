...
// Hero carousel images (Studex)
import Studex1 from "../../../assets/3Studex/Studex1.png";
...
const Studex = () => {
  ...
  const images = [
    ...
    { src: Studex2, alt: "Studex 2" },
    { src: Studex1, alt: "Studex 1 duplicate" },
    { src: Studex2, alt: "Studex 2 duplicate" },
    { src: Studex1, alt: "Studex 1 duplicate" },
    { src: Studex2, alt: "Studex 2 duplicate" },
  ];
  ...
  const tech = [
    ...
    { icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/electron/electron-original.svg", label: "Electron JS" },
    ...
    { icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/opencv/opencv-original.svg", label: "YOLO" },
    ...
    <ProjectLayout title="Studex" subtitle="Tech project" showHero={false} showBack={false} fullWidth={true} contentPadding="py-0" contentGap="space-y-0">
      <div className="relative isolate rounded-3xl p-4 sm:p-6 md:p-8">
        ...
        <section className="relative w-full">
          ...
          <div className="relative overflow-hidden bg-neutral-900 shadow-2xl" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} aria-label="Studex preview carousel">
        ...
        <section className="mx-auto mt-3 max-w-5xl">
          ...
          <p className="mt-4 max-w-3xl text-xl lg:text-2xl leading-relaxed text-gray-300">
            <strong>AI-powered, distraction-free learning app</strong> (migrating from Electron to Flutter/Dart).
          </p>
          <ul className="mt-4 list-disc pl-6 text-gray-300 space-y-2 max-w-3xl">
            <li>Kiosk/fullscreen study sessions, app/site blocking, focus timer, streaks.</li>
            <li>Voice/Chat assistant for summaries, Q&A on PDFs, and study planning.</li>
            <li>Report-card analysis → personalized roadmap; embedded edu video support.</li>
            <li>Session analytics, notes, and progress tracking; clean, low-distraction UI.</li>
          </ul>
        </section>
        ...
        <section className="mx-auto mt-12 max-w-5xl">
          ...
          <div className="border border-white/10 bg-white/5"><img src={ApproachImg} alt="Approach diagram" className="w-full h-auto object-contain" /></div>
        </section>
