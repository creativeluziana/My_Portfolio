...
import ProjectImage from '../../../assets/Projects/Aarohan.png';
import ApproachImg from '../../../assets/Projects/Aarohan.png';
import ResultsImg from '../../../assets/Projects/Aarohan.png';
import { Link } from 'react-router-dom';
import Footer from '../../../components/Footer';

const Aarohan = () => {
  const images = Array(6).fill({ src: ProjectImage, alt: 'Aarohan' });
  ...
  return (
    <ProjectLayout title="Aarohan" subtitle="Tech project" showHero={false} showBack={false} fullWidth={true} contentPadding="py-0" contentGap="space-y-0">
      <div className="relative isolate rounded-3xl p-4 sm:p-6 md:p-8">
        ...
        <section className="mx-auto mt-10 flex max-w-5xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <h1 className="text-5xl lg:text-6xl font-medium" style={{ background: 'linear-gradient(90deg, #FFFFFF 0%, #D770D7 50%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Aarohan</h1>
