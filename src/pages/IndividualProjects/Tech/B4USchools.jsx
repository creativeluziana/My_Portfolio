...
// Hero carousel images (B4U Schools)
...
const BaysideSports = () => {
  ...
  const images = [
    ...
    { src: Bayside2, alt: "Dashboard" },             // 2
    { src: Bayside3, alt: "Booking flow" },          // 3
    { src: Bayside4, alt: "Payments" },              // 4
    { src: Bayside5, alt: "Analytics" },             // 5
    { src: Bayside6, alt: "Mobile UI" },             // 6
  ];
      ...
      <div className="relative isolate rounded-3xl p-4 sm:p-6 md:p-8">
        ...
        <section className="mx-auto mt-3 max-w-5xl">
          ...
          <p className="mt-4 max-w-3xl text-xl lg:text-2xl leading-relaxed text-gray-300">
            <strong>School discovery & shortlist helper for parents/students.</strong>
          </p>
          <ul className="mt-4 list-disc pl-6 text-gray-300 space-y-2 max-w-3xl">
            <li>Search by location/fees/boards; compare key stats; save shortlists.</li>
            <li>Inquiry/visit booking and document checklist.</li>
            <li>Content pages for admissions timelines and guidance.</li>
          </ul>
        </section>

        {/* Tech Stack */}
        <section className="mx-auto mt-8 max-w-5xl">
          <h3 className="text-3xl lg:text-4xl font-normal text白e">Tech Stack</h3>
