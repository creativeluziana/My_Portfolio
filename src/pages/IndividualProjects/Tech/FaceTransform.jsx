...
// Hero carousel images (Face Transform)
import F1 from "../../../assets/7FaceTransform/FaceT1.png";
import F2 from "../../../assets/7FaceTransform/FaceT2.png";
import F3 from "../../../assets/7FaceTransform/FaceT3.png";
import F4 from "../../../assets/7FaceTransform/FaceT4.png";
import F5 from "../../../assets/7FaceTransform/FaceT5.png";
import F6 from "../../../assets/7FaceTransform/FaceT6.png";
...
const FaceTransform = () => {
  // Slides
  const images = [
    { src: F1, alt: "Face Transform 1" },
    { src: F2, alt: "Face Transform 2" },
    { src: F3, alt: "Face Transform 3" },
    { src: F4, alt: "Face Transform 4" },
    { src: F5, alt: "Face Transform 5" },
    { src: F6, alt: "Face Transform 6" },
  ];
    ...
    <ProjectLayout title="Face Transform" subtitle="Tech project" showHero={false} showBack={false} fullWidth={true} contentPadding="py-0" contentGap="space-y-0">
      <div className="relative isolate rounded-3xl p-4 sm:p-6 md:p-8">
        ...
        <section className="relative w-full">
          ...
          <div className="relative overflow-hidden bg-neutral-900 shadow-2xl" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} aria-label="Face Transform preview carousel">
        ...
        <section className="mx-auto mt-3 max-w-5xl">
          ...
          <p className="mt-4 max-w-3xl text-xl lg:text-2xl leading-relaxed text-gray-300">
            <strong>AI image playground for face effects & styles.</strong>
          </p>
          <ul className="mt-4 list-disc pl-6 text-gray-300 space-y-2 max-w-3xl">
            <li>Upload photo → apply filters (style transfer, background blur, color grading).</li>
            <li>Before/after compare, safeguard rails, and export in multiple sizes.</li>
            <li>Built for quick social assets and profile shots.</li>
          </ul>
        </section>
