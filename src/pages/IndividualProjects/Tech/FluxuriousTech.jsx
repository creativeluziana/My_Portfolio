...
// Hero carousel images (Fluxurious Tech)
import Flux1 from "../../../assets/2FluxuriousTech/Flux1.png";
import Flux2 from "../../../assets/2FluxuriousTech/Flux2.png";
import Flux3 from "../../../assets/2FluxuriousTech/Flux3.png";
import Flux4 from "../../../assets/2FluxuriousTech/Flux4.png";
import Flux5 from "../../../assets/2FluxuriousTech/Flux5.png";
...
const BaysideSports = () => {
  ...
  const images = [
    ...
    { src: Flux2, alt: "Fluxurious Tech 2" },
    { src: Flux3, alt: "Fluxurious Tech 3" },
    { src: Flux4, alt: "Fluxurious Tech 4" },
    { src: Flux5, alt: "Fluxurious Tech 5" },
    { src: Flux6, alt: "Fluxurious Tech 6" },
  ];

  const tags = ["Web Design", "Web Development"];
  const visitUrl = "https://www.fluxurioustech.com/"; // Update with live link if available
      ...
      <div className="relative isolate rounded-3xl p-4 sm:p-6 md:p-8">
        ...
        <section className="relative w-full">
          ...
          >
            ...
            <button
              onClick={prev}
              className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-black/50 px-3 py-2 text白e hover:bg-black/70 focus:outline-none"
        ...
        <section className="mx-auto mt-3 max-w-5xl">
          ...
          <p className="mt-4 max-w-3xl text-xl lg:text-2xl leading-relaxed text-gray-300">
            <strong>Freelance studio site</strong> focused on premium UI and credibility.
          </p>
          <ul className="mt-4 list-disc pl-6 text-gray-300 space-y-2 max-w-3xl">
            <li>Sections for services, process, team values, and current/past client work.</li>
            <li>Emphasis on <strong>Web Apps, Web Dev, Web Design, App Development, Full-Stack</strong> projects.</li>
            <li>Purple-tinted visual system; smooth micro-interactions and case-study cards.</li>
          </ul>
        </section>
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {tech.map((t, i) => (
              ...
              >
                ...
                <span className="text-lg lg:text-XL leading-relaxed font-normal text白e" style={{ lineHeight: '1.6', wordSpacing: '0.05em', letterSpacing: '0.01em' }}>{t.label}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto mt-12 max-w-5xl">
          ...
          <div className="border border白e/10 bg-white/5">
